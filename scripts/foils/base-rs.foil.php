...
<asSet
  ...
  <description>
    <line number="0">All Route Server Participants at NINJA-IX-<?=$scrmarket ?></line>
  </description>
  ...
  <remarks>
    ...
    <line number="4"></line>
    <line number="5">There are seperate IPv4 and IPv6 files available as well.</line>
  </remarks>
  <source>ARIN</source>
  <members>
...
<?php if( str_starts_with($cust->peeringmacro, 'AS') !== false ): ?>
...
<?php endforeach; ?>
  ...
  <name>AS-NINJA-IX-<?=$scrmarket ?>-RS-ALL</name>
</asSet>
